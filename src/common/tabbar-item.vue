<template>
    <a class="m-tabbar-item" :class="{'is-active':isActive}" @click.stop="goToRouter">
 ...
 *       <img src="~@/assets/ic_tab_home_normal.png" alt="" slot="icon-normal"> 
 *       <img src="~@/assets/ic_tab_home_active.png" alt="" slot="icon-active"> 
 *       首页
 * </m-tabbar-item>
 */
    export default{
